...
<p><strong>1. 実験設定</strong>：最初に、習慣改善のための実験を設定します。たとえば「環境の整備」という介入策を選び、「帰宅後すぐに作業用シャツに着替える」と入力すれば、それがあなたの生産的作業のためのトリガーとなります。あらかじめ決めた期間中、その介入策を実施し、生産的作業につながるかどうかを試しましょう。</p>
<p><strong>2. 日次記録</strong>：実験が始まれば、毎日の記録を作成します。まず、その日に作業を実施できたかどうかを記録してください。作業が実施できていれば、開始時間帯や継続時間、自己評価等を記録します。</p>
<p><strong>3. 結果表示</strong>：毎日の記録は、後から確認することができます。カレンダーで日付ごとの実施状況、グラフで継続時間の推移や時間帯との相関を視覚的に確認できます。</p>
<p><strong>4. 介入策一覧</strong>：どんな介入策を実施すべきか迷ったときは、この画面を確認しましょう。各介入策の趣旨や具体例が示されています。</p>
</div>`,
            errors: {
