...
<p><strong>1. 実験設定</strong>：最初に、習慣改善のための実験を設定します。たとえば「環境の整備」という介入策を選び、「帰宅後すぐに作業用シャツに着替える」と入力すれば、それがあなたの生産的作業のためのトリガーとなります。あらかじめ決めた期間中、その介入策を実施し、生産的作業につながるかどうかを試しましょう。あらかじめ決めた通知時刻になれば、日次記録の作成をリマインドしてくれるので、記録を取り忘れる心配もありません。</p>
<p><strong>2. 日次記録</strong>：実験が始まれば、毎日の記録を作成します。まず、その日に作業を実施できたかどうかを記録してください。作業が実施できていれば、開始時間帯や継続時間、集中度を始めとした自己評価、簡単なメモ等を記録します。なお、作業が実施できていない日は、そのまま保存ボタンを押してください。「今日はだめだった」という結果も、実験においては大切なデータです。</p>
<p><strong>3. 結果表示</strong>：毎日の記録は、後から確認することができます。日次記録参照欄を押すと、記録のある日のみを表示したカレンダーが表示されます。作業を実施できた日は「緑」、実施できなかった日は「緑」で表示されるため、その日の実施可否が一目でわかります。また、各種のグラフによって、日付ごとの継続時間の推移や時間帯と自己評価との相関を視覚的に確認できます。これらを使って、自己分析を行ってみるのも良いでしょう。</p>
