...
<p style="margin-top: 12px;"><strong>3. 結果表示</strong>：毎日の記録は、後から確認することができます。日次記録参照欄を押すと、記録のある日のみを表示したカレンダーが表示されます。作業を実施できた日は「緑」、実施できなかった日は「緑」で表示されるため、その日の実施可否が一目でわかります。また、各種のグラフによって、日付ごとの継続時間の推移や時間帯と自己評価との相関を視覚的に確認できます。これらを使って、自己分析を行ってみるのも良いでしょう。</p>
