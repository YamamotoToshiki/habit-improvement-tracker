const translations = {
    ja: {
        ...
        login: {
            ...
            welcomeMessage: `<div style="text-align: left;">
<h2 style="text-align: center; margin-bottom: 16px;">習慣改善トラッカーへようこそ</h2>
<hr style="margin: 16px 0; border: none; border-top: 1px solid rgba(0,163,191,0.3);">
<h3 style="margin-top: 16px;">概要</h3>
<p>これは、行動科学に基づいて、あなたの習慣を改善するための実験を行うためのアプリケーションです。<br>
生産的な作業を習慣化したいと思いながら、ついダラダラと過ごしてしまうことがありませんか？<br>
そんなあなたの日々を、このアプリケーションで改善しましょう。</p>
<h3 style="margin-top: 16px;">使い方</h3>
<p style="margin-top: 12px;"><strong>1. 実験設定</strong>：最初に、習慣改善のための実験を設定します。たとえば「環境の整備」という介入策を選び、「帰宅後すぐに作業用シャツに着替える」と入力すれば、それがあなたの生産的作業のためのトリガーとなります。あらかじめ決めた期間中、その介入策を実施し、生産的作業につながるかどうかを試しましょう。あらかじめ決めた通知時刻になれば、日次記録の作成をリマインドしてくれるので、記録を取り忘れる心配もありません。</p>
<p style="margin-top: 12px;"><strong>2. 日次記録</strong>：実験が始まれば、毎日の記録を作成します。まず、その日に作業を実施できたかどうかを記録してください。作業が実施できていれば、開始時間帯や継続時間、集中度を始めとした自己評価、簡単なメモ等を記録します。なお、作業が実施できていない日は、そのまま保存ボタンを押してください。「今日はだめだった」という結果も、実験においては大切なデータです。</p>
<p style="margin-top: 12px;"><strong>3. 結果表示</strong>：毎日の記録は、後から確認することができます。日次記録参照欄を押すと、記録のある日のみを表示したカレンダーが表示されます。作業を実施できた日は「緑」、実施できなかった日は「赤」で表示されるため、その日の実施可否が一目でわかります。また、各種のグラフによって、日付ごとの継続時間の推移や時間帯と自己評価との相関を視覚的に確認できます。これらを使って、自己分析を行ってみるのも良いでしょう。</p>
<p style="margin-top: 12px;"><strong>4. 介入策一覧</strong>：実験を設定するにあたって、どんな介入策を実施すべきか、しっくりこないかもしれません。そんなときは、この画面を確認しましょう。ここでは、各介入策の趣旨や具体例が示されています。きっと、あなたの介入策選択の手助けになるはずです。</p>
</div>`,
            errors: {
        ...
        common: {
            ...
            notificationDisabled: "<p>通知は無効です。</p><p>端末の設定から許可してください。</p>"
        }
    },
    en: {
